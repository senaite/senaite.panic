...
#
# Copyright 2019-2025 by it's authors.
# Some rights reserved, see README and LICENSE.

from senaite.panic import DEFAULT_PROFILE_ID
from senaite.panic import PRODUCT_NAME
from senaite.panic import UNINSTALL_PROFILE_ID
...
def setup_handler(context):
    ...
    """
    if context.readDataFile('senaite.panic.install.txt') is None:
        return
